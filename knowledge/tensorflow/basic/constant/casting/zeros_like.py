...
# original = tf.constant([1,2,3,4,5], dtype=tf.float16)
...
p.printValue("tf.zeros_like(original, dtype=tf.float32)", data)
data = tf.zeros_like(original, dtype=tf.float32_ref)
p.printValue("tf.zeros_like(original, dtype=tf.float32_ref)", data)
data = tf.zeros_like(original, dtype=tf.float64)
p.printValue("tf.zeros_like(original, dtype=tf.float64)", data)
data = tf.zeros_like(original, dtype=tf.float64_ref)
p.printValue("tf.zeros_like(original, dtype=tf.float64_ref)", data)
data = tf.zeros_like(original, dtype=tf.int8)
p.printValue("tf.zeros_like(original, dtype=tf.int8)", data)
data = tf.zeros_like(original, dtype=tf.int8_ref)
p.printValue("tf.zeros_like(original, dtype=tf.int8_ref)", data)
data = tf.zeros_like(original, dtype=tf.int16)
p.printValue("tf.zeros_like(original, dtype=tf.int16)", data)
data = tf.zeros_like(original, dtype=tf.int16_ref)
p.printValue("tf.zeros_like(original, dtype=tf.int16_ref)", data)
data = tf.zeros_like(original, dtype=tf.int32)
p.printValue("tf.zeros_like(original, dtype=tf.int32)", data)
data = tf.zeros_like(original, dtype=tf.int32_ref)
p.printValue("tf.zeros_like(original, dtype=tf.int32_ref)", data)
data = tf.zeros_like(original, dtype=tf.int64)
p.printValue("tf.zeros_like(original, dtype=tf.int64)", data)
data = tf.zeros_like(original, dtype=tf.int64_ref)
p.printValue("tf.zeros_like(original, dtype=tf.int64_ref)", data)
data = tf.zeros_like(original, dtype=tf.uint8)
p.printValue("tf.zeros_like(original, dtype=tf.uint8)", data)
data = tf.zeros_like(original, dtype=tf.uint8_ref)
p.printValue("tf.zeros_like(original, dtype=tf.uint8_ref)", data)

data = tf.zeros_like(original, dtype=tf.double)
p.printValue("tf.zeros_like(original, dtype=tf.double)", data)
data = tf.zeros_like(original, dtype=tf.double_ref)
p.printValue("tf.zeros_like(original, dtype=tf.double_ref)", data)
data = tf.zeros_like(original, dtype=tf.complex64)
p.printValue("tf.zeros_like(original, dtype=tf.complex64)", data)
data = tf.zeros_like(original, dtype=tf.complex64_ref)
p.printValue("tf.zeros_like(original, dtype=tf.complex64_ref)", data)
data = tf.zeros_like(original, dtype=tf.complex128)
p.printValue("tf.zeros_like(original, dtype=tf.complex128)", data)
data = tf.zeros_like(original, dtype=tf.complex128_ref)
p.printValue("tf.zeros_like(original, dtype=tf.complex128_ref)", data)

# 特殊情况
data = tf.zeros_like(original, dtype=tf.float16)
# p.printValue("tf.zeros_like(original, dtype=tf.float16)", data)
data = tf.zeros_like(original, dtype=tf.float16_ref)
# p.printValue("tf.zeros_like(original, dtype=tf.float16_ref)", data)
data = tf.zeros_like(original, dtype=tf.uint16)
# p.printValue("tf.zeros_like(original, dtype=tf.uint16)", data)
data = tf.zeros_like(original, dtype=tf.uint16_ref)
# p.printValue("tf.zeros_like(original, dtype=tf.uint16_ref)", data)
